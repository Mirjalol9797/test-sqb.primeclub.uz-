...
//
// В сборку токен не попадает никогда: import.meta.env.DEV в ней false, условие
// сворачивается в false ещё при компиляции и весь блок вырезается из бандла —
// даже если VITE_DEV_TOKEN задан в .env.production.
//
// Чтобы отключить и на дев-сервере — уберите VITE_DEV_TOKEN из .env.
